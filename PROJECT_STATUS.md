...
V5-B subsequently completed the committed double replay and independent
verification. Three cap-0.40 candidates passed every frozen gate. The
lexicographic safety rule selected `v5-a100-b40`: 629/1,773 reuses (35.48%,
95% episode-bootstrap interval [34.18%, 36.54%]), 17.74% theoretical logical
visual-work reduction (95% interval [17.09%, 18.27%]), maximum streak one,
zero prefix violations, zero gripper-transition reuses, zero isolation
mismatches, and zero invariant failures. This is a positive offline mechanism
