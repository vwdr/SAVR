#!/usr/bin/env python3
"""Create and attest the canonical non-interactive LIBERO config for V5-D v03."""
...
def main() -> int:
    ...
    if root != EXPECTED_ROOT:
        raise SystemExit(f"Refusing V5-D v03 config preparation outside {EXPECTED_ROOT}: {root}")
