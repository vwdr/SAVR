...
| Offline Full Refresh replay underestimated online reuse in all nine settings | `reports/PHASE6R_A_DIAGNOSIS_REPORT.md` | Replay was not an online reuse-budget or safety oracle in this study |
...
| The paper summarizes 1,160 terminal episodes | The four reports above | 100 FR + 900 SAVR1 + 90 SAVR2 + 70 SAVR3 |

## Claims intentionally blocked

- SAVR or visual caching is universally unsafe.
